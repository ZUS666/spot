...
from spots.constants import (
    DAYS_CHOICES, END_CHOICES_LOCATION, LAT_MAX, LAT_MIN, LAT_MSG_ERROR,
    LONG_MAX, LONG_MIN, LONG_MSG_ERROR, MEETING_ROOM, NAME_CACHE_MEETING_ROOM,
    NAME_CACHE_WORKSPACE, START_CHOICES_LOCATION, WORK_SPACE,
...
class Location(models.Model):
    ...
    open_time = models.TimeField(
        'Время открытия',
        choices=START_CHOICES_LOCATION,
        default=START_CHOICES_LOCATION[0][0],
    )
    close_time = models.TimeField(
        'время закрытия',
        choices=END_CHOICES_LOCATION,
        default=END_CHOICES_LOCATION[0][0],
    )
